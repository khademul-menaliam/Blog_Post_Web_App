...
class AdminAvertisementController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.advertisement.index', compact('adds'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.advertisement.create', compact('post'));
    }
